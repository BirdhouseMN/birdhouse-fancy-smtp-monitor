...
= 1.0.39 =
* Remove the Birdhouse security Reply-To header from child-site verification emails.

= 1.0.38 =
* Label child-site proof emails as manual or automatic so successful auto probes can be filtered out of normal inboxes.
